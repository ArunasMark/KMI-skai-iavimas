...
<div class="container-fluid col-6 bg-primary bg-opacity-10 mt-5">
    ...
    <table class="table table-bordered border border-dark w-25 text-center">
        ...
        <tr>
            <td class="col-3">
                <p class="fs-5 fw-bold text-dark p-1 mb-0">Jūsų KMI indeksas: </p>
                <span
                        class="fs-3 align-middle fw-bold bg-danger text-dark ">
                            <?php
                            if ($rezult > '25.0') {
                                echo($rezult);
                            }
                ...
                <span class="fs-3 align-middle fw-bold bg-warning text-dark ">
                            <?php
                            if ($rezult < '18.5') {
                                echo($rezult);
                            }
                ...
                <span class="fs-3 align-middle fw-bold bg-success text-dark ">
                            <?php
    ...
    <table class="table table-bordered border border-dark">
        ...
        <tr class="pt-5">
            <th colspan="12" class="text-uppercase  text-black pt-5  ">gauti rezultatai</th>
        </tr>
        </thead>
    ...
    <div class=" container-fluid text-secondary fw-bolder fs-6 ps-0">
        <p class="mb-0">Įvestas svoris: <?php echo $svoris; ?> kg.</p>
        <p>Įvestas ūgis: <?php echo $ugisMetrais; ?> m.</p>
    </div>
    <div class="button ms-0 mb-3 text-center">
